...
const describeActions = (name, structure) => {
  ...
  describe(name, () => {
    ...
    it('should create change action', () => {
      expect(change('myForm', 'myField', 'bar', empty, false))
        .toEqual({
          type: CHANGE,
          meta: {
            form: 'myForm',
        ...
        .toPass(isFSA)
      expect(change('myForm', 'myField', 7, empty, true))
        .toEqual({
          type: CHANGE,
          meta: {
            form: 'myForm',
...
describeActions('actions.plain', plain)
describeActions('actions.immutable', immutable)
